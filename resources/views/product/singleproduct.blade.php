...
<head>
	...
	<!-- Icons -->
	<link rel="shortcut icon" href="bigbag/bigbag/img/favicon.png">
...
<body class="body-wrapper version1">
	...
	<div class="main-wrapper">
		...
		<div class="header clearfix">
			...
			<!-- TOPBAR -->
			@include('partials.topbar_frontend')

			<!-- NAVBAR -->
			@include('partials.navbar_frontend')
		</div>
			...
			<div class="container">
						...
						<div class="media flex-wrap">
								...
								<div id="carousel" class="carousel slide" data-ride="carousel">
									<div class="carousel-inner">
										<div class="carousel-item active" data-thumb="0">
											<img src="{{ asset('/img/'.$barangs->foto.'')}}">
										</div>
										<div class="carousel-item" data-thumb="1">
											<img src="bigbag/img/products/signle-product/product-slide-big-02.jpg">
										</div>
										<div class="carousel-item" data-thumb="2">
											<img src="bigbag/img/products/signle-product/product-slide-big-03.jpg">
										</div>
										<div class="carousel-item" data-thumb="3">
											<img src="bigbag/img/products/signle-product/product-slide-big-04.jpg">
										</div>
									</div>
								</div>
								<div class="clearfix">
									<div id="thumbcarousel" class="carousel slide" data-interval="false">
										<div class="carousel-inner">
											<div data-target="#carousel" data-slide-to="0" class="thumb">
												<img src="bigbag/img/products/signle-product/product-slide-small-01.jpg">
											</div>
											<div data-target="#carousel" data-slide-to="1" class="thumb">
												<img src="bigbag/img/products/signle-product/product-slide-small-02.jpg">
											</div>
											<div data-target="#carousel" data-slide-to="2" class="thumb">
												<img src="bigbag/img/products/signle-product/product-slide-small-03.jpg">
											</div>
											<div data-target="#carousel" data-slide-to="3" class="thumb">
												<img src="bigbag/img/products/signle-product/product-slide-small-04.jpg">
											</div>
										</div>
							...
							<div class="media-body">
								<ul class="list-inline">
									<li><a href="{{ url('/')}}"><i class="fa fa-reply" aria-hidden="true"></i>Continue Shopping</a></li>
								</ul>
				...
				<div class="row productsContent">
					<div class="col-md-3 col-12 ">
						<div class="productBox">
							<div class="productImage clearfix">
								<img src="bigbag/img/products/products-01.jpg" alt="products-img">
					...
					<div class="col-md-3 col-12 ">
						<div class="productBox">
							<div class="productImage clearfix">
								<img src="bigbag/img/products/products-02.jpg" alt="products-img">
								<div class="productMasking">
									<ul class="list-inline btn-group" role="group">
										<li><a data-toggle="modal" href=".html" class="btn btn-default"><i class="fa fa-heart-o"></i></a></li>
										<li><a href="cart-page.html" class="btn btn-default"><i class="fa fa-shopping-basket"></i></a></li>
					...
					<div class="col-md-3 col-12 ">
						<div class="productBox">
							<div class="productImage clearfix">
								<img src="bigbag/img/products/products-03.jpg" alt="products-img">
								<div class="productMasking">
									<ul class="list-inline btn-group" role="group">
										<li><a data-toggle="modal" href=".html" class="btn btn-default"><i class="fa fa-heart-o"></i></a></li>
										<li><a href="cart-page.html" class="btn btn-default"><i class="fa fa-shopping-basket"></i></a></li>
					...
					<div class="col-md-3 col-12 ">
						<div class="productBox">
							<div class="productImage clearfix">
								<img src="bigbag/img/products/products-04.jpg" alt="products-img">
								<div class="productMasking">
									<ul class="list-inline btn-group" role="group">
										<li><a data-toggle="modal" href=".html" class="btn btn-default"><i class="fa fa-heart-o"></i></a></li>
										<li><a href="cart-page.html" class="btn btn-default"><i class="fa fa-shopping-basket"></i></a></li>
		...
		<!-- COPY RIGHT -->
		@include('partials.copyright_frontend')
	</div>
				...
				<div class="modal-body">
					...
					<div class="media flex-wrap">
						<div class="media-left px-0">
							<img class="media-object" src="bigbag/img/products/quick-view/quick-view-01.jpg" alt="Image">
						</div>
						<div class="media-body">
